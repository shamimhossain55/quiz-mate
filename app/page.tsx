  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-sm border border-slate-100 text-center">
        ...
        <p className="text-slate-500 mb-8">আপনার কুইজ যাত্রা শুরু করতে গুগল দিয়ে লগইন করুন</p>
        ...
        <p className="mt-8 text-xs text-slate-400">
          ...
          <a href="#" className="underline hover:text-blue-600">নিয়মাবলী ও গোপনীয়তা নীতি</a> মেনে নিচ্ছেন।
        </p>
      </div>
    </div>
  );
